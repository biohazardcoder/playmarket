...
function ProductDetail() {
    ...
    return (
        <div>
            ...
            <div className='w-full h-[80vh] bg-[#181818] text-white flex p-20 flex-col justify-center sm:p-8 md:p-12'>
                <h1 className='text-2xl font-semibold'>{product.title}</h1>
                <h1 className=''>{product.category}</h1>
                <h1 className='text-green-300 text-xs'>In-app purchases</h1>
                <div className='flex gap-8 py-5 flex-col sm:flex-row'>
                    ...
                    <div className='text-center'>
                        ...
                        <h1 className='text-xs'>Downloaded: {product.download}</h1>
                    </div>
                    <h1 className='flex flex-col items-center'>
                        <span className='bg-white text-black p-1 font-bold'>{product.age}+</span>
                    </h1>
                </div>
                <h1 className='text-xs text-[#ddd]'>
                    This game requires the Google Play Games (<u>Beta</u>) app to install on your <u>Windows</u> PC. <br />
                    By downloading it and the game, you agree to the Google <u>Terms of Service</u> and the Google Play <u>Terms of Service</u>. <br />
                    <a href="" className='underline'>Learn more…</a>
                </h1>
            </div>
            <div className='h-screen p-10 w-full flex flex-col md:flex-row gap-4 justify-between'>
                ...
                <div className='w-full md:w-1/4 h-full bg-[#181818] p-6 rounded-lg'>
                    ...
                    <div>
                        ...
                        <Link href={"/"}>
                            <span className='text-sm text-green-300 font-semibold'>Find out <br /> more</span>
                        </Link>
                    </div>
                    ...
                    <div className='text-stone-400 text-sm py-6'>
                        Detailed information about these system requirements can be found in the Help Center. <br />
                        Intel is a registered trademark of Intel Corporation or its subsidiaries. Windows is a trademark of the Microsoft group of companies. <br />
                                ...
                                {product.comments?.map((item, index) => (
                                    <div key={index} >
                                        <div className='flex items-center gap-2'>
                                            <img src={item.user?.avatar} alt="avatar" className='w-10 h-10 rounded-md' />
                                        ...
                                        <div className="flex">
                                            {[...Array(5)].map((_, starIndex) => (
                                                <span key={starIndex} className={`text-2xl ${starIndex < item.like ? "text-green-500" : "text-gray-400"}`}>
                                                    ★
                                                </span>
                                            ))}
                                        </div>
